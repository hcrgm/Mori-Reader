...
@Composable
internal fun MiuixCategoryManagerSheet(
    show: Boolean,
...
@Composable
private fun LazyItemScope.MiuixCategoryManageItem(
...
@Composable
internal fun MiuixCreateCategoryDialog(
    show: Boolean,
    onDismiss: () -> Unit,
...
@Composable
internal fun MiuixRenameCategoryDialog(
    category: BookCategory?,
    onDismiss: () -> Unit,
...
@Composable
internal fun MiuixDeleteCategoryDialog(
    category: BookCategory?,
    onDismiss: () -> Unit,
