...
interface BookRepository {
    ...
    suspend fun renameCategory(id: String, name: String): BookCatalog
    suspend fun reorderCategories(categoryIds: List<String>): BookCatalog
    suspend fun deleteCategory(id: String): BookCatalog
    suspend fun updateBookCategories(bookId: String, categoryIds: List<String>): BookCatalog
    suspend fun deleteBook(bookId: String): BookCatalog
}

@Composable
expect fun rememberBookRepository(): BookRepository

@Composable
expect fun rememberEpubPicker(
